...
public class Reusable_Actions_BNYM {
    ...
    public static void clickAction1(WebDriver driver,String xpath, String elementName){
    ...
    public static void scrollAction1(WebDriver driver, String xpath, String elementName){
        WebDriverWait wait = new WebDriverWait(driver,timeout);
    ...
    //create a scroll method
    public static void scrollActionPoint(WebDriver driver, String elementName){
        WebDriverWait wait = new WebDriverWait(driver,timeout);
        JavascriptExecutor jse = (JavascriptExecutor) driver;
        try{
    ...
    public static void switchTabByIndexAction(WebDriver driver, String xpath, int userValue, String elementName){
        WebDriverWait wait = new WebDriverWait(driver,timeout);
        try{
            WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath)));
            ...
            System.out.println("Unable to switch tab on element " + elementName + " " + e);
        }
    }//end of switch tabs
